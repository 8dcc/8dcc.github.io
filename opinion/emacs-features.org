...
This package, uses Emacs' [[https://www.gnu.org/software/emacs/manual/html_node/flymake/index.html][flymake]] for syntax checking. I personally don't like
it, so I disable it by setting =eglot-stay-out-of=, and replace it with [[#flycheck][flycheck]].

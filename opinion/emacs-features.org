...
Emacs has an excellent integration with [[https://www.sourceware.org/gdb/][gdb]]. You can run =M-x gud-gdb=, and you can
get basically what you would get by running =gdb= on a terminal.
...
Behold, the beauty of GNU Emacs.

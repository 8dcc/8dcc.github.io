#+TITLE: Introduction to network programming in C
#+AUTHOR: 8dcc
#+STARTUP: nofold
...
At the time of writing this article, I am somewhat new to network programming,
so if you have any suggestions, please feel free to [[https://github.com/8dcc/8dcc.github.io][contribute]] to this page.

If you are interested on reading more about network programming, I recommend
reading [[https://beej.us/guide/bgnet/][Beej's Guide to Network Programming]].

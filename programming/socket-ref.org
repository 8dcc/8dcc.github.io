#+TITLE: Quick reference for socket programming in C
#+AUTHOR: 8dcc
#+OPTIONS: toc:nil
#+STARTUP: nofold
...
This article is meant to be a quick reference for C programmers who are
interested in socket programming on Unix-like systems. The code in this article

...
signature scanning library in pure C for GNU/Linux.
...
first scans the specified IDA signature in the specified module. The second is
just a wrapper for passing =NULL= to the first one, therefore scanning all loaded
modules.
